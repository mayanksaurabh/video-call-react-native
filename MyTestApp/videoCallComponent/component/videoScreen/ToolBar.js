...
export default class ToolBar extends Component {
    state = {
      ...
      static getDerivedStateFromProps(props, state) {
          console.log("props toolbar js----->",props);
          console.log("state toolbar js----->",state);
      ...
      // local stream or initRemote thoda samjhna hai isme
      startCall = () => {
          console.log("this.props toolbar js ----->", this.props);
            const {
                selectedUsersIds,
                closeSelect,
                initRemoteStreams,
      ...
      stopCall = () => {
        ...
        resetState(); // ye func definition kahan hai
      }
